...
program
  ...
  .option('-n, --number <number>', 'starting lines number, default 10', Number, 5)
  ...
  .option('-m, --mail <mail>', 'Enable send email feature: 1: enable; 0: diable',Number, 1)
  .option('-s, --slack <slack>', 'Post message to slack: 1: enable; 0: diable',Number, 1)
